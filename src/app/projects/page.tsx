...
const PROJECTS = [
  {
    ...
    description:
      'a playful reimagining of canonical texts through the lens of contemporary internet vernacular',
  ...
  },
  {
    title: 'time is money',
    description:
      'a chrome extension that translates price tags into hours of your labor, so you see exactly how long you’d need to work to buy that coffee',
    techStack: ['javascript', 'chrome api'],
    siteUrl:
      'https://chromewebstore.google.com/detail/time-is-money/ooppbnomdcjmoepangldchpmjhkeendl?hl=en',
  ...
  },
  {
    title: 'studymode',
    description:
      'create ai-generated quizzes, tailored to your learning goals, and use spaced repetition to master any subject',
  ...
  },
  {
    ...
    description:
      'a blogging platform with bitcoin lightning payment support for seamless microtransactions',
