  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col admin-layout">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <Link href="/admin" className="text-gray-800 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 flex items-center">
      ...
      {isAuthenticated && pathname !== '/admin/login' && isMobileMenuOpen && (
        <div className="md:hidden bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow dark:shadow-gray-900/50" id="mobile-menu">
