      ...
      <div className="border-b border-gray-200 dark:border-gray-700">
        <div className="grid grid-cols-12 py-2 px-4 text-xs font-medium text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-750" role="row">
          <div 
            ...
            role="columnheader"
            aria-sort={sort.field === 'text' ? (sort.order === 'asc' ? 'ascending' : 'descending') : 'none'}
            tabIndex={0}
          >
            <span>QUOTE</span>
            {sort.field === 'text' ? (
      ...
      {quotes.length === 0 ? (
        <div className="p-8 text-center text-gray-500 dark:text-gray-400">
          ...
          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
            {searchQuery ? 'Try adjusting your search criteria or filters' : 'Start building your collection of inspirational quotes'}
          </p>
        </div>
      ) : (
              ...
              <div className="flex flex-col">
                ...
                <div className="mt-1 ml-5.5 text-xs text-gray-500 dark:text-gray-400">
                  {searchQuery && quote.author && quote.author.toLowerCase().includes(searchQuery.toLowerCase()) ? (
                    <>— <span className="inline-block">{highlightSearchTerm(quote.author, searchQuery)}</span></>
                  ) : (
