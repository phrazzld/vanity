  ...
  try {
    ...
    return parts.map((part, i) => {
      ...
      if (part.toLowerCase() === searchTerm.toLowerCase()) {
        return <mark key={i} className="bg-yellow-100 dark:bg-yellow-900 text-gray-900 dark:text-yellow-200 px-0.5 rounded">{part}</mark>;
      }
      return part;
    });
  } catch (error) {
  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700">
        <div className="grid grid-cols-12 py-2 px-4 text-xs font-medium text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-750" role="row">
          <div 
            ...
            role="columnheader"
            aria-sort={sort.field === 'title' ? (sort.order === 'asc' ? 'ascending' : 'descending') : 'none'}
            tabIndex={0}
          >
            <span>TITLE</span>
            {sort.field === 'title' ? (
              sort.order === 'asc' ? <SortAscIcon /> : <SortDescIcon />
            ) : (
          ...
          <div 
            ...
            role="columnheader"
            aria-sort={sort.field === 'author' ? (sort.order === 'asc' ? 'ascending' : 'descending') : 'none'}
            tabIndex={0}
          >
            <span>AUTHOR</span>
            {sort.field === 'author' ? (
          ...
          <div 
            ...
            role="columnheader"
            aria-sort={sort.field === 'date' ? (sort.order === 'asc' ? 'ascending' : 'descending') : 'none'}
            tabIndex={0}
          >
            <span>DATE</span>
            {sort.field === 'date' ? (
      ...
      {readings.length === 0 ? (
        <div className="p-8 text-center text-gray-500 dark:text-gray-400">
          ...
          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
            {searchQuery ? 'Try adjusting your search criteria or filters' : 'Start building your literary collection'}
          </p>
        </div>
      ) : (
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-sm font-medium text-gray-900 dark:text-white truncate flex gap-1 items-center">
                    {searchQuery && reading.title.toLowerCase().includes(searchQuery.toLowerCase()) ? (
                  ...
                  <div className="mt-1 text-xs text-gray-600 dark:text-gray-300 truncate">
                    {searchQuery && reading.author.toLowerCase().includes(searchQuery.toLowerCase()) ? (
